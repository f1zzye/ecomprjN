...
class Vendor(models.Model):
    ...
    # description = models.TextField(null=True, blank=True, default="I'm amazing vendor.")

    address = models.CharField(max_length=100, default='123 Main Street.')
    contact = models.CharField(max_length=100, default='+123 (456) 789-1011')
...
class Product(models.Model):
    ...
    price = models.DecimalField(max_digits=99, decimal_places=2, default='1,99')
    old_price = models.DecimalField(max_digits=99, decimal_places=2, default='2,99')
...
class CartOrderItems(models.Model):
    ...
    price = models.DecimalField(max_digits=99, decimal_places=2, default='1,99')
    total = models.DecimalField(max_digits=99, decimal_places=2, default='1,99')
...
################################## Product Review , Wishlishs, Address ##########################################
################################## Product Review , Wishlishs, Address ##########################################
################################## Product Review , Wishlishs, Address ##########################################
